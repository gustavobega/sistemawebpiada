...
@WebServlet(name = "CtrBuscaPiada", urlPatterns = {"/CtrBuscaPiada"})
public class CtrBuscaPiada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.getWriter().print(buscaPiadas("cat_cod = "+categoria));    
    }
