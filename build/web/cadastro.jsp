...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <!-- Login Form -->
            <form name="dados" onsubmit="Cadastrar()">
              <input type="text" id="login" class="fadeIn second" name="nome" placeholder="Nome Completo">
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
              <a class="underlineHover" href="login.jsp">Sair</a>
            </div>
